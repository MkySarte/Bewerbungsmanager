...
public record CreateBewerbungseintragRequest(
        @Positive Long bewerbungscontainerId,
        @Positive Long firmaId,
        @Positive Long stellenausschreibungId,
        @Positive Long statusId,
        @Size(max = 255) String containerName,
        @Size(max = 255) String firmaName,
        @Size(max = 255) String stellenbezeichnung,
